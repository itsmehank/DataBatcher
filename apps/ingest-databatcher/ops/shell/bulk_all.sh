...
if [ ! -f "apps/ingest-databatcher/scripts/table_manipulate/manage_table.py" ]; then
    ...
    echo "  bash apps/ingest-databatcher/ops/shell/bulk_all.sh"
    exit 1
fi
...
run_step "3-4" python apps/ingest-databatcher/scripts/kr_minervini_update.py --days 9999
...
run_step "4-4" python apps/ingest-databatcher/scripts/us_minervini_update.py --days 9999
