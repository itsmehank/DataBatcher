...
if [ ! -f "apps/ingest-databatcher/scripts/table_manipulate/manage_table.py" ]; then
    ...
    echo "  bash apps/ingest-databatcher/ops/shell/bulk_all_test.sh"
    exit 1
fi
...
run_step "0-2" python apps/ingest-databatcher/scripts/us_sync_symbol_master.py --skip-yfinance
run_step "0-3" python apps/ingest-databatcher/scripts/crypto_sync_symbol_master.py --symbols BTCUSDT ETHUSDT
...
run_step "1-1" python apps/ingest-databatcher/scripts/kr_index_bulk_update.py --start "$START_DATE" --end "$YESTERDAY" --market KOSPI
...
run_step "2-1" python apps/ingest-databatcher/scripts/us_index_bulk_update.py --start "$START_DATE" --end "$YESTERDAY" --market SP500
...
run_step "3-1" python apps/ingest-databatcher/scripts/bulk_update.py --start "$START_DATE" --end "$YESTERDAY" --top 3 --workers "$WORKERS"
run_step "3-2" python apps/ingest-databatcher/scripts/bulk_update_weekly.py --top 3
run_step "3-3" python apps/ingest-databatcher/scripts/kr_rs_update.py --days 5
...
run_step "4-1" python apps/ingest-databatcher/scripts/us_bulk_update.py --start "$START_DATE" --end "$YESTERDAY" --top 3 --workers "$WORKERS" --with-indicators
run_step "4-2" python apps/ingest-databatcher/scripts/us_bulk_update_weekly.py --top 3
run_step "4-3" python apps/ingest-databatcher/scripts/us_rs_update.py --days 5
...
run_step "5-1" python apps/ingest-databatcher/scripts/crypto_bulk_update_daily.py --symbols BTCUSDT ETHUSDT --start "$START_DATE" --end "$YESTERDAY" --with-indicators
run_step "5-2" python apps/ingest-databatcher/scripts/crypto_bulk_update_weekly.py --symbols BTCUSDT ETHUSDT --start "$START_DATE" --end "$YESTERDAY" --with-indicators
